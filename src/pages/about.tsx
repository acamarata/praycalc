    ...
    <MainLayout>
      <div className="aboutContainer">
        ...
        <div className={styles.content}>
          ...
          <p>As PrayCalc is currently in its Beta stage, we are actively seeking feedback to improve our service. We greatly appreciate any comments or suggestions you may have, and we encourage you to send them to <a href="mailto:info@praycalc.net">info@praycalc.net</a>. Together, we can create the most accurate and reliable prayer times calculator available.</p>
        </div>
      </div>
    </MainLayout>
  );
